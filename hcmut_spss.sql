...
--
-- Metadata for table permitted_file_type
--

--
-- Metadata for table printer
--
...
('root', 'hcmut_spss', 'print_request', '{\"CREATE_TIME\":\"2023-11-27 22:12:20\",\"col_order\":[0,1,2,3,4,5,6,7,8],\"col_visib\":[1,1,1,1,1,1,1,1,1],\"sorted_col\":\"`request_id` ASC\"}', '2023-11-28 14:54:37');
...
--
-- Metadata for database hcmut_spss
--
COMMIT;
